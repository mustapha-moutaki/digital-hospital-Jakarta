...
<head>
    <meta charset="UTF-8">
    <title>Update department name</title>
...
<main class="main-content">
    <div class="form-container">
        ...
        <form action="<%= request.getContextPath() %>/department" method="post">
            ...
            <input  value="<%= department.getName()%>" type="text" id="departmentname" name="departmentname" placeholder="Enter new department name" required>

            <button type="submit"><i class="fa-solid fa-plus-circle"></i> Update Department</button>
        </form>
