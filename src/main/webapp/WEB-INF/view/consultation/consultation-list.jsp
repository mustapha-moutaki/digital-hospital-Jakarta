...
<%--                                <c:forEach var="status" items="${T(org.mustapha.digitalhospitaljee.model.enums.ConsultationStatus).values()}">--%>
<%--                                    <option value="${status}" ${status == c.consultationStatus ? 'selected' : ''}>${status}</option>--%>
<%--                                </c:forEach>--%>
<%--                            </select>--%>
